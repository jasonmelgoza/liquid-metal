...
export const Logo = (props: HTMLChakraProps<"svg">) => {
  return (
    <chakra.svg width={"33px"} height={"28px"} fill="none" {...props}>
      <path
        fill="url(#a)"
        d="m32.174 13.917-7.143-1.325-.818 1.419-2.012 3.492-5.224 9.067c-.228.397-.831.234-.831-.225v-8.448a.897.897 0 0 0-.721-.881l-8.139-1.603-7.285-1.335c.011.38.1.757.27 1.106l6.013 10.46A4.681 4.681 0 0 0 10.347 28l11.53-.015a4.681 4.681 0 0 0 4.056-2.364l5.885-10.288c.25-.437.369-.928.356-1.416Z"
      />
      <path
        fill="url(#b)"
